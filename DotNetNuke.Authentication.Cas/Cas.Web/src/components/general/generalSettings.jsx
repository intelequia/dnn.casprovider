...
class GeneralSettings extends Component {
    ...
    onSettingChange(key, event) {
        ...
        props.dispatch(SettingsActions.settingsClientModified({
            enabled: (key === "CasProviderEnabled") ? !props.enabled : props.enabled,
    ...
    render() {
        return (
            <div className="dnn-cas-generalSettings">
                <GridCell columnSize={50}>
                    ...
                    <Switch label={resx.get("lblEnabled")}
                        ...
                        onChange={this.onSettingChange.bind(this, "CasProviderEnabled")} />
